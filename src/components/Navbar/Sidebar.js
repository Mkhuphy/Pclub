        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-6">
                <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                    Any user signing up with your referral id would contribute 40 credits to your CA account.Other ways of earning credits are through shares on social media platforms.
                </p>
                <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                    On the basis of these credits, you would be winning goodies.
                </p>
            </div>
